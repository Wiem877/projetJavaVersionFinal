...
public class LoginAdminInterface extends JFrame {
	private Connection connection; // Ajoutez une connexion à la base de données

    public LoginAdminInterface(Connection connection){
        ...
        JLabel userLabel = new JLabel("Numero compte admin");
        ...
        loginButton.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                if (user.authentifier(numCompte, password, connection)) {
                    ...
                    new GestionClients(); // Transmettez également la connexion si nécessaire
                } else {
    ...
    public static void main(String[] args) {
        ...
        try (Connection connection = DriverManager.getConnection("jdbc:mysql://localhost:3306/gestion", "root", "root")) {
            SwingUtilities.invokeLater(() -> new LoginAdminInterface(connection));
